...
from transformers import Mask2FormerForUniversalSegmentation, SamModel, SamImageProcessor
...
class Mask2FormerLightning(pl.LightningModule):
    def __init__(self, config: Config):
        ...
        self.segmentation_loss_fct = self.configure_criterion()
        self.consistency_loss_fct = SS2Mask2FormerLoss(self.model.config)
        self.sam_loss_fct = SS2Mask2FormerLoss(self.model.config)
    ...
    def configure_criterion(self):
        ...
        return SS2Mask2FormerLoss(self.model.config, weight=weight)
